      ...
      <div className="flex w-[96%] py-3 justify-between items-center">
        <div className="flex items-center ">
          <GiHamburgerMenu
            ...
            size="25px"
            className="mr-3 h-10 w-10 p-3 rounded-full  hover:bg-[#e0e0e0] cursor-pointer"
          />
          <img
            className="px-4"
            width={"115px"}
        ...
        <div className="flex w-[40%] items-center">
          <div className="flex w-[100%] ">
            ...
            <button
              onClick={searchVideo}
              className="border border-gray-400 rounded-r-full  py-2 px-3 bg-[#F8F8F8] hover:bg-[#e0e0e0]"
            >
              <CiSearch size="24px" />
            </button>
          </div>
